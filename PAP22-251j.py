...
print(ms.val('s1_p', s1_p * 100, d_s1_p * 100) + "%")
print()
print(ms.sig('s1,0', s1, d_s1, 0.0))
print(ms.val('T1', T1 / sc.hour) + " hours")
print(ms.val('s1_p + Δs1_p', (s1_p + d_s1_p) * 100) + "%")
print(ms.val('s1_p + 2 Δs1_p', (s1_p + 2 * d_s1_p) * 100) + "%")
print()
print(ms.val('s2', s2, d_s2))
print(ms.val('s2_p', s2_p * 100, d_s2_p * 100) + "%")
print()
print(ms.sig('s2,0', s2, d_s2, 0.0))
print(ms.val('T2', T2 / sc.hour) + " hours")
print(ms.val('s2_p + Δs2_p', (s2_p + d_s2_p) * 100) + "%")
print(ms.val('s2_p + 2 Δs2_p', (s2_p + 2 * d_s2_p) * 100) + "%")
print()
