...
ms.pltext.initplot(num=1, xlabel=r'$Z$', ylabel=r'$\sqrt{E_\alpha} / \sqrt{\mathrm{eV}}$')
...
ms.pltext.initplot(num=2, xlabel=r'$Z$', ylabel=r'$\sqrt{E_\beta} / \sqrt{\mathrm{eV}}$')
...
sigma2_12 = -sqrt(4 / 3) * b2 / sqrt(E2_R)
